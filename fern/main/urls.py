...
from .views import main, authentication, inventory, usercart, userprofile
...
urlpatterns = [
    ...
    path('uploadImg/', view.uploadImg, name='uploadImg'),
    ...
    path('userorders/', view.userorders, name='userorders'),
